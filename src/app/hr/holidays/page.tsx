        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-100">
              ...
              <th className="px-6 py-4 font-medium text-gray-500">Descripción</th>
              <th className="px-6 py-4 font-medium text-gray-500 w-24 text-right">Acciones</th>
            </tr>
          </thead>
          <tbody>
            {loading ? (
              ...
              feriados.map((feriado) => (
                <tr key={feriado.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-gray-600">{feriado.descripcion}</td>
